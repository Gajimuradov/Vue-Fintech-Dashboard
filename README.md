...
Компактный pet-проект на Vue 3 + TypeScript для резюме frontend internship в финтех-компании. Приложение показывает список операций, фильтрует и сортирует их, открывает детальную страницу операции и демонстрирует базовую работу с состояниями загрузки, ошибки и пустого результата.
